...
class EventsApi:
    ...
    delete_event_url = f"{base_url}/v3/customers/AppTest/events/65330b6d-ba13-4bc6-9a3c-c1ee79bfca8f"
    delete_wrong_event_url = f"{base_url}/v3/customers/AppTest/events/65330b6d"
    event_by_id_url = f"{base_url}/v3/customers/AppTest/events/65330b6d-ba13-4bc6-9a3c-c1ee79bfca8f"
    ...
    def delete_wrong_event(self, headers=None, use_default_token=True):
        ...
        return (self.api_executor.get(
            url=self.delete_wrong_event_url,
            headers=headers or self.token
        ))
